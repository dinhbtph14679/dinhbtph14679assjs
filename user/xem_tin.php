...
<head>
    ...
    <link rel="stylesheet" href="./../css/user/xem_tin.css">
                    ...
                    <div class="sp">
                        <div class="ct_sp">
                            <section class="tieude_sp">
                                    <h2>Tin tức > Các máy Mac trong tương lai có thể được trang bị chip 3nm lên tới 40 lõi</h2>
                            </section>
                            <section class="chi_tiet">
                                <?php require './../user/xem_tin_main.php' ?>
